...
#import "PetPhotoViewController.h"
#import "PetPhotoDetailViewController.h"
@interface PetPhotoViewController ()

@end

@implementation PetPhotoViewController
...
- (IBAction)petcamera:(id)sender {
    {
        ...
        else
        {
            ...
            switch (r) {
                case 0:
                    image = [UIImage imageNamed:@"IMG_0002.jpg"];
                    break;
                case 1:
                    image = [UIImage imageNamed:@"IMG_0003.jpg"];
                    break;
                case 2:
                    image = [UIImage imageNamed:@"IMG_0004.jpg"];
                    break;
                case 3:
                    image = [UIImage imageNamed:@"IMG_0006.jpg"];
                    break;
                case 4:
                    image = [UIImage imageNamed:@"IMG_0007.jpg"];
                    break;
                default:
                    break;
            }
...
- (void)setUpImages:(NSArray *)images
{
    ...
    //code to create an apple style image picker, opened from view controller via delegate method in .h class
    //brian allen
...
- (void)buttonTouched:(id)sender {
   ...
   [self performSegueWithIdentifier:@"pet1" sender:sender];
 
   
}
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
	if ([segue.identifier isEqualToString:@"pet1"])
	{
		UINavigationController *navigationController =
        segue.destinationViewController;
		PetPhotoDetailViewController
        *ppdViewController =
        [[navigationController viewControllers]
         objectAtIndex:0];
		ppdViewController.delegate = self;
        ...
        ppdViewController.selectedImage = selectedPhoto;
...
//delegate functions for petphotodetail
- (void)PetPhotoDetailViewControllerDone:(PetPhotoDetailViewController *)controller
