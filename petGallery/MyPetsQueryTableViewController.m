...
@interface MyPetsQueryTableViewController : PFQueryTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath object:(PFObject *)object {
    ...
    gameLabel.text =    [petobjdata objectForKey:@"Name"];
    ...
    PFImageView *petimgview = (PFImageView *)[cell viewWithTag:1];
